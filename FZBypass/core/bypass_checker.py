...
async def direct_link_checker(link, onlylink=False):
    ...
    # DDL Links
       ...
       #blink = await gyanilinks(link)
        ...
        blink = await transcript(link, "https://themezon.net/", "https://en.shrinke.me/", 10)
    elif bool(match(r"https?:\/\/gtlinks\.\S+", link)):
        blink = await transcript(link, "https://gyanitheme.com/", "https://www.hipsonyc.com/", "https://golink.gyanitheme.com/", 7)
    elif bool(match(r"https?:\/\/.+\.tnshort\.\S+", link)):
        blink = await transcript(link, "https://go.tnshort.net/", "https://jrlinks.in/", 8)
